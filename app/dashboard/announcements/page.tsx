  ...
  return (
    <div className="space-y-6">
            ...
            {visibleItems.map((a) => (
              <AnnouncementPostCard
                ...
                adminActions={{
                  ...
                  onTogglePin: () => {
                    togglePin(a.id, session?.name ?? "Staff")
                    toast.success(a.isPinned ? "Announcement unpinned." : "Announcement pinned to top.")
                  },
      ...
      <ConfirmDialog
        ...
        onConfirm={() => {
          if (deletingId) {
            deleteAnnouncement(deletingId, session?.name ?? "Staff")
